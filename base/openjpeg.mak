...
open_jpeg_OBJS = \
	...
	$(OPEN_JPEG_OBJ)$(OPEN_JPEG_PREFIX)getrusage.$(OBJ)
...
$(OPEN_JPEG_OBJ)$(OPEN_JPEG_PREFIX)getrusage.$(OBJ) : $(OPEN_JPEG_SRC)getrusage.c $(open_jpeg_HDRS) $(OPEN_JPEG_DEP)
	$(OPEN_JPEG_CC) $(OPEN_JPEG_O)getrusage.$(OBJ) $(C_) $(OPEN_JPEG_SRC)getrusage.c
